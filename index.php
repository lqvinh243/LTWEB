...
<?php endif; ?>
<?php if($user): ?>
<h1 class="text-center">Chào mừng <?php echo $user['Name'] ?> đã quay trở lại</h1>
...
<?php else : ?>
<h2 class="text-center my-4">Chào mừng bạn đến với trang web của Lê Quang Vinh,Đăng ký để sử dụng các chức năng pro nhất</h2>
<?php endif; ?>
